...
void XPT2046_TouchDown(strType_XPT2046_Coordinate * touch)
{
  ...
  switch(page)
	{
		case 0:
			Library_Button_Hover(touch->x,touch->y);
			break;
		case 1:
			Clock_Button_Hover(touch->x,touch->y);
			break;
		case 2:
			Clock_Zone_Config_Button_Hover(touch->x,touch->y);
			break;
		case 3:
			Clock_Stop_Button_Hover(touch->x,touch->y);
			break;
		case 4:
			Clock_Alert_Button_Hover(touch->x,touch->y);
			break;
		case 5:
			Temperature_Button_Hover(touch->x,touch->y);
			break;
...
void XPT2046_TouchUp(strType_XPT2046_Coordinate * touch) 
{
	...
	{
		case 0:
			Library_Button_Release(touch->pre_x,touch->pre_y);
			break;
		case 1:
			Clock_Button_Release(touch->pre_x,touch->pre_y);
			break;
		case 2:
			Clock_Zone_Config_Button_Release(touch->pre_x,touch->pre_y);
			break;
		case 3:
			Clock_Stop_Button_Release(touch->x,touch->y);
			break;
		case 4:
			Clock_Alert_Button_Release(touch->x,touch->y);
			break;
		case 5:
			Temperature_Button_Release(touch->x,touch->y);
			break;
